...
import { footerLinks, serviceText } from "./StaticData";
    ...
    <footer className="bg-white">
      ...
      <div className="container mx-auto px-4 py-4">
          ...
          <div className="text-center mb-16 w-1/3">
            ...
            <form className="flex max-w-md mx-auto">
              <input
                ...
                className="flex-1 px-4 py-2 border border-r-0 border-gray-300 rounded-md rounded-e-none focus:outline-none focus:ring-2 focus:ring-green-600"
              />
              <button
                type="submit"
                className="px-6 py-2 bg-green-600 text-white rounded-md rounded-s-none hover:bg-green-700 transition-colors"
              >
                Join
              </button>
            </form>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-16">
          ...
          <div>
            <h4 className="font-bold text-lg mb-4">Help & Guide</h4>
            <ul className="space-y-2">
